...
(function (root, factory) {
    ...
    function mapDownloadError(error) {
        ...
        if (/PRO_REQUIRED/i.test(haystack)) {
            return t('common.proOnly', 'This feature requires MediaFlow Pro.');
        }
        if (/DAILY_LIMIT/i.test(haystack)) {
            return t('download.dailyLimitReached', 'Daily free download limit reached. Upgrade for unlimited.');
        }
